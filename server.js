...
app.get("/api/rent-loan-rate", async (req, res) => {
  ...
  try {
    const apiUrl =
      "http://apis.data.go.kr/B551408/rent-loan-rate-info/rate-list?serviceKey=Fd9vStrV5WKcvb5kTCXeBBw1zyOOxNrOysX80lQ02PLaIWqI7PFfY7PlcJopX/3kd5FYkiHYt6QYbhItGuhIhQ==&numOfRows=10&pageNo=1&dataType=xml";
